        ...
        bikes: [
          {
            ...
            is_stock_img: false,
            large_img:
              'https://files.bikeindex.org/uploads/Pu/325671/large_490F803A-EF1F-4889-96B5-FBA0FF247AD4.jpeg',
            location_found: null,
            ...
            stolen_location: 'US',
            thumb:
              'https://files.bikeindex.org/uploads/Pu/325671/small_490F803A-EF1F-4889-96B5-FBA0FF247AD4.jpeg',
...
const mockRejectCall = () => {
  mockedAxios.get.mockImplementationOnce(() =>
    Promise.reject(new Error('internal err~')),
  )
}
